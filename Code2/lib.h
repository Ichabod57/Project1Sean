...
double ran2(long *);
double ran3(long *);
double offdiagfind2(double **, int &, int &, int);
double offdiagfind(double **, int &, int &, int);
void JacobiRotSym(double ** , double ** , int &, int &, int );
void JacobiRotNonSym(double ** , double ** , int &, int &, int );
void MatMult(double **, double **, double **, int );
void VecMatMult(double **, double *, double *, int );
double VecMult(double *, double *, int);
void MatVecMult(double **, double *, double *, int);